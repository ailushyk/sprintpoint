...
>(({ side = 'right', className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    >
      ...
      <DrawerPrimitive.Close className="absolute right-4 top-4 hidden rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-secondary md:block">
...
const DrawerHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-2 border-b pb-2 pt-6 text-center dark:border-primary-foreground sm:text-left',
      className
    )}
    {...props}
  />
...
const DrawerBody = ({
  ...
  <div className={cn('mb-4 flex-1 overflow-y-auto', className)} {...props} />
)
